...
public class AsyncMyAccountApiBuilder {
     ...
     * Sets token
     */
    public AsyncMyAccountApiBuilder token(String token) {
        this.token = token;
        return this;
    }

    public AsyncMyAccountApiBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public AsyncMyAccountApiBuilder url(String url) {
     ...
     */
    public AsyncMyAccountApiBuilder timeout(int timeout) {
     ...
     */
    public AsyncMyAccountApiBuilder maxRetries(int maxRetries) {
     ...
     */
    public AsyncMyAccountApiBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public AsyncMyAccountApiBuilder logging(LogConfig logging) {
     ...
     */
    public AsyncMyAccountApiBuilder addHeader(String name, String value) {
        this.customHeaders.put(name, value);
        return this;
    }

    public AsyncMyAccountApiBuilder host(String host) {
        this.host = host;
        return this;
    }
    ...
    protected void setEnvironment(ClientOptions.Builder builder) {
        if (this.host != null) {
            String _host = this.host != null ? this.host : "auth0.auth0.com";
            this.environment = Environment.custom("https://{host}/me/v1".replace("{host}", _host));
        }
    ...
    public AsyncMyAccountApi build() {
        if (token == null) {
            throw new RuntimeException("Please provide token");
        }
        validateConfiguration();
        return new AsyncMyAccountApi(buildClientOptions());
    }
}
