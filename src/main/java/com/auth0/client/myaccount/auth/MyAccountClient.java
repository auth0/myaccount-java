...
import com.auth0.client.myaccount.MyAccountApi;
import com.auth0.client.myaccount.MyAccountApiBuilder;
...
/**
 * Auth0 My Account API client with automatic token management.
 *
 * <p>Wraps the Fern-generated {@link MyAccountApi} with dynamic authentication,
 ...
 * }</pre>
 *
 * <p>Example — static token:
 * <pre>{@code
 * MyAccountClient client = MyAccountClient.builder()
 *     .domain("tenant.auth0.com")
 *     .staticToken(userAccessToken)
 *     .build();
 * }</pre>
 */
public final class MyAccountClient extends MyAccountApi {

    private MyAccountClient(ClientOptions clientOptions) {
        super(clientOptions);
    }

    /**
     * Creates a new builder for {@link MyAccountClient}.
     */
    public static Builder builder() {
        return new Builder();
    }

    public static final class Builder extends MyAccountApiBuilder {
