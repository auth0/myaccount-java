...
public class MyAccountApiBuilder {
     ...
     * Sets token
     */
    public MyAccountApiBuilder token(String token) {
        this.token = token;
        return this;
    }

    public MyAccountApiBuilder environment(Environment environment) {
        this.environment = environment;
        return this;
    }

    public MyAccountApiBuilder url(String url) {
     ...
     */
    public MyAccountApiBuilder timeout(int timeout) {
     ...
     */
    public MyAccountApiBuilder maxRetries(int maxRetries) {
     ...
     */
    public MyAccountApiBuilder httpClient(OkHttpClient httpClient) {
     ...
     */
    public MyAccountApiBuilder logging(LogConfig logging) {
     ...
     */
    public MyAccountApiBuilder addHeader(String name, String value) {
        this.customHeaders.put(name, value);
        return this;
    }

    public MyAccountApiBuilder host(String host) {
        this.host = host;
        return this;
    }
    ...
    public MyAccountApi build() {
        if (token == null) {
            throw new RuntimeException("Please provide token");
        }
        validateConfiguration();
        return new MyAccountApi(buildClientOptions());
    }
}
